          ...
          <div class="container-fluid">
            ...
            <!--Tabla-->
              ...
              <table id="list" class="table table-striped table-hover table-bordered table-sm dt-responsive nowrap" width="100%" cellspacing="0">
                <thead class="thead">
                  <tr>
                    <th class="all print">R.I.F.</th>
                    <th class="print">Razón Social</th>
                    <th class="print">Teléfono</th>
                    <th class="none print">Dirección Fiscal</th>
                    <th class="none ">Datos del Representante:</th>
                    <th class="none ">Cédula</th>
                    <th class="none ">Nombre y Apellido</th>
