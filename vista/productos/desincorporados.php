...
<head>
  <meta charset="UTF-8">
  <title>Existencias Desincorporadas</title>
      ...
      <div class="col-12 col-md-9 main">
        <section class="jumbotron jumbotron-fluid listado">
          <div class="container-fluid">
            <h1 class="text-center">Existencias Desincorporadas</h1>
            <!--Tabla-->
              <!-- Lista -->
              <table id="list" class="table table-striped table-hover table-bordered table-sm dt-responsive nowrap" width="100%" cellspacing="0">
                <thead class="thead">
                  <tr>
                    ...
                    <th class="none">Razón de Desincorporación</th>
                    <th class="none">Fecha de Desincorporación</th>
