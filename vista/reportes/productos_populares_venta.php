      ...
      <div class="col-12 col-md-9 main">
        <section class="jumbotron jumbotron-fluid listado">
          <div class="container-fluid">
            <div class="row my-2">
              <div class="col-3">
                <form method="POST" action="pdf_productos_populares_venta.php" target="_blank">
    ...
    function submitForm()
      {
        ...
        window.open("pdf_productos_populares_venta.php","ventanaImprimir","width=500,height=300,toolbar=0");
