      ...
      <div class="col-12 col-md-9 main">
        <section class="jumbotron jumbotron-fluid listado">
          <div class="container-fluid">
            <h1 class="text-center">Cuentas por pagar a proveedores</h1>
            <!--Tabla-->
              <!-- Lista -->
              <table id="list" class="table table-striped table-hover table-bordered table-sm dt-responsive nowrap" width="100%" cellspacing="0">
                <thead class="thead">
                  <tr>
                    <th class="all print">Serie y Nro.</th>
                    <th class="print">Emitido</th>
                    <th class="print">Proveedor</th>
                    <th class="print">Monto</th>
                    <th class="print">Vence</th>
                    <th class="none">R.I.F. de Proveedor</th>
                    <th class="none">Teléfono de Proveedor</th>
                    <th class="none">Dirección de Proveedor</th>
                    <?php
