...
<head>
  <meta charset="UTF-8">
  <title>Lista de Facturas de Ventas</title>
      ...
      <div class="col-12 col-md-9 main">
        <section class="jumbotron jumbotron-fluid listado">
          <div class="container-fluid">
            <h1 class="text-center">Listado de Facturas de Venta</h1>
            <!--Tabla-->
              <!-- Lista -->
              <table id="list" class="table table-striped table-hover table-bordered table-sm dt-responsive nowrap" width="100%" cellspacing="0">
                <thead class="thead">
                  <tr>
                    <th class="all print">Numero</th>
                    <th class="print">Serie</th>
                    <th class="print">Cliente</th>
                    <th class="none print">Tipo</th>
                    <th class="none print">Fecha de Emision</th>
                    <th class="none print">Fecha Final de Pago</th>
                    <th class="print">Vendedor</th>
                    <th class="print">Sub-Total</th>
...
?>
                ...
                <tfoot>
                  <tr>
                    ...
                    <th>Cliente</th>
                    <th>Tipo</th>
                    <th class="none">Fecha de Emision</th>
                    <th class="none">Fecha Final de Pago</th>
                    <th>Vendedor</th>
                    <th>Sub-Total</th>
                    <th>I.V.A.</th>
                    <th>Total</th>
