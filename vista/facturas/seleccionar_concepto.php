      ...
      <div class="col-12 col-md-9 main">
        <section class="jumbotron jumbotron-fluid listado">
          <div class="container-fluid">
            <h1 class="text-center">Seleccione un Lote</h1>
            <!--Tabla-->
              <!-- Lista -->
              <table id="list" class="table table-striped table-hover table-bordered table-sm dt-responsive nowrap" width="100%" cellspacing="0">
                ...
                <tbody>
<?php
  $seleccionar_concepto_venta=true;
            ...
            { 
              ...
              customize: function ( win ) {
                $(win.document.body)
                  .css( 'font-size', '16pt' )
                  .prepend(
                    '<img src="http://192.168.1.100/vista/complementos/portada_reporte.png" style="top:0; left:0;width:100%;height:100%;" />'
                  );
