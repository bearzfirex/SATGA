      ...
      <div class="col-12 col-md-9 main text-center">
        <section class="jumbotron jumbotron-fluid">
          <div class="container-fluid">
            <h1>Seleccione el tipo de factura</h1>
            <hr class="my-4">

            <div class="row d-flex justify-content-center">
              <div class="col-10 col-md-6">
                <a class="btn btn-primary btn-lg btn-block mt-2 mt-md-5" href="listar_compra.php"><i class="fa fa-cart-plus"></i> Comprobate de Compra <i class="fa fa-cart-plus"></i></a>
              </div>              
            </div>
            <div class="row d-flex justify-content-center">
              <div class="col-10 col-md-6">
                <a class="btn btn-primary btn-lg btn-block mt-2 mt-md-5" href="listar_venta.php"><i class="fa fa-cart-arrow-down"></i> Factura de Venta <i class="fa fa-cart-arrow-down"></i></a>
              </div>
            </div>
        </section>
      </div>
