        ...
        <section class="jumbotron jumbotron-fluid formulario-sm">
          <div class="container-fluid">
            ...
            <form method="POST" action="../../controlador/proveedores.php">
              ...
              <div class="form-group row d-flex justify-content-center">
                ...
                <div class="col-8 col-md-4">
                  <div class="input-group input-group-sm">
                    ...
                    pattern='[Vv]{1}-[0-9]{8}-[0-9]{1}|[Gg]{1}-[0-9]{8}-[0-9]{1}|[Jj]{1}-[0-9]{8}-[0-9]{1}|[Ee]{1}-[0-9]{8}-[0-9]{1}' title='Ejemplo: V-01234567-8/G-12345678-1/J-12345678-9'
              ...
              <div class="form-group row d-flex justify-content-center">
                <label for="razon_social" class="col-2 col-md-2 col-form-label col-form-label-sm text-left"><b>Razón Social</b></label>
                <div class="col-8 col-md-4">
                  <div class="input-group input-group-sm">
